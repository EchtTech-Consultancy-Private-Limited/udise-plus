                            ...
                            <TableContainer className="mt-4">
                                <Table>
                                    ...
                                    <TableRow>
                                            ...
                                            <TableCell>School</TableCell>
                                            <TableCell>
                                                <Link className="action-icon" to="/infrastructure-reports3013?id=3013&report_name=Number of Schools by Availability of Infrastructure and Facilities, School Management and School Category&type=table"><img src={Tableicon} alt="" /></Link>
                                                <Link className="action-icon" to="/infrastructure-reports3013?id=3013&report_name=Number of Schools by Availability of Infrastructure and Facilities, School Management and School Category&type=graph"><img src={graph} alt="" /></Link>
                                                <Link className="action-icon" to="/infrastructure-reports3013?id=3013&report_name=Number of Schools by Availability of Infrastructure and Facilities, School Management and School Category&type=about"><img src={Download} alt="" /></Link>
                                            </TableCell>                                          
                                        </TableRow>                                      
                                        <TableRow>
                                            <TableCell>2</TableCell>
