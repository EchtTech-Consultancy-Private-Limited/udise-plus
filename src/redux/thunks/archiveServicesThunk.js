...
const fetchArchiveServicesSchoolData = createAsyncThunk(
  ...
  async ({year_id,region_type,region_code,category_code,management_code}) => {
    const response = await externalAxios.get(`${year_id}/${region_type}/${region_code}/${category_code}/${management_code}/`);
